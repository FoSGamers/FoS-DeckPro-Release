...
class FoSGamersChatSplitter:
    def __init__(self, root):
        ...
        self.root.geometry("600x600")  # Larger window for clarity
        self.root.configure(bg="#333333")  # Dark background for contrast
        
        # Variables
        self.json_file_path = tk.StringVar()
        self.output_dir_path = tk.StringVar()
        self.image_dir_path = tk.StringVar()  # New: Image folder
    ...
    def create_widgets(self):
        ...
        json_frame = tk.Frame(self.root, bg="#333333")
        ...
        self.json_button = tk.Button(json_frame, text="Browse", command=self.browse_json_file, 
                                   bg="#00FF00", fg="#FFFFFF", font=("Arial", 12, "bold"), 
                                   width=14, bd=2, highlightbackground="#FFFFFF", relief="raised")
        self.json_button.pack(pady=5)

        output_frame = tk.Frame(self.root, bg="#333333")
        ...
        self.output_button = tk.Button(output_frame, text="Browse", command=self.browse_output_dir, 
                                     bg="#00FF00", fg="#FFFFFF", font=("Arial", 12, "bold"), 
                                     width=14, bd=2, highlightbackground="#FFFFFF", relief="raised")
        self.output_button.pack(pady=5)

        image_frame = tk.Frame(self.root, bg="#333333")
        ...
        self.image_button = tk.Button(image_frame, text="Browse", command=self.browse_image_dir, 
                                     bg="#00FF00", fg="#FFFFFF", font=("Arial", 12, "bold"), 
                                     width=14, bd=2, highlightbackground="#FFFFFF", relief="raised")
        self.image_button.pack(pady=5)

        name_frame = tk.Frame(self.root, bg="#333333")
        ...
        size_frame = tk.Frame(self.root, bg="#333333")
        ...
        process_frame = tk.Frame(self.root, bg="#333333")
        process_frame.pack(pady=20)
        self.process_button = tk.Button(process_frame, text="Split Chats", command=self.process_chats, 
                                      bg="#00FF00", fg="#FFFFFF", font=("Arial", 14, "bold"), 
                                      width=16, bd=2, highlightbackground="#FFFFFF", relief="raised")
    ...
    def browse_json_file(self):
        ...
        if file_path:
            ...
            self.json_button.configure(bg="#00FF00")  # Back to green when done
    ...
    def browse_output_dir(self):
        ...
        if dir_path:
            ...
            self.output_button.configure(bg="#00FF00")  # Back to green when done

    def browse_image_dir(self):
        self.image_button.configure(bg="#FF0000")  # Turn red when clicked
        dir_path = filedialog.askdirectory()
        if dir_path:
            self.image_dir_path.set(dir_path)
            self.image_button.configure(bg="#00FF00")  # Back to green when done
    ...
    def find_image_file(self, asset_pointer):
        ...
        if not image_dir or not asset_pointer:
            return None
        # Extract file ID (e.g., file-7eKFjTMMKf8jL9irybsue6V7 from file-service://file-7eKFjTMMKf8jL9irybsue6V7)
        file_id = asset_pointer.replace("file-service://", "")
        # Look for files with matching ID (try common extensions)
        ...
        for part in parts:
            if isinstance(part, str):
                ...
                if part.get('content_type') == 'image_asset_pointer':
                    # Extract image file path if available
    ...
    def process_chats(self):
        ...
        if not json_file or not os.path.exists(json_file):
            ...
            self.process_button.configure(bg="#00FF00")
            return
        if not output_dir:
        ...
        try:
            ...
            for convo in conversations:
                ...
                # Write individual conversation file (use only title)
            ...
            self.process_button.configure(bg="#00FF00")  # Back to green

        except Exception as e:
            messagebox.showerror("Whoops!", f"Something broke: {str(e)}")
            self.process_button.configure(bg="#00FF00")  # Back to green on error
