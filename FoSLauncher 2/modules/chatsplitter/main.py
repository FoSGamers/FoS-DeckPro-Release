...
class FoSGamersChatSplitter:
    def __init__(self, root):
        ...
        self.style.theme_use("clam")  # Use 'clam' theme for better macOS rendering
        self.style.configure("Green.TButton", background="#00FF00", foreground="#FFFFFF", 
                           font=("Arial", 12, "bold"), padding=10)
        self.style.map("Green.TButton", background=[("active", "#00CC00")])
        self.style.configure("Red.TButton", background="#FF0000", foreground="#FFFFFF", 
                           font=("Arial", 12, "bold"), padding=10)
